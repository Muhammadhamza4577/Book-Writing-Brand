			...
			<div class="row">
				...
				<div class="col-md-2">
					...
					<ul>
						...
						<li><a href="javascript:void(0)">How Trustpilot works</a></li>
						<li><a href="javascript:void(0)">Transparency Report</a></li>
				...
				<div class="col-md-2">
					<h5>Community</h5>
					<ul>
						<li><a href="javascript:void(0)">Trust in reviews us</a></li>
						<li><a href="javascript:void(0)">Help Center</a></li>
						<li><a href="javascript:void(0)">Log in</a></li>
						<li><a href="javascript:void(0)">Sign up</a></li>
						<li><a href="javascript:void(0)">Chrome App</a></li>
					</ul>
				</div>
				<div class="col-md-2">
				<h5>Businesses</h5>
					<ul>
						<li><a href="javascript:void(0)">Trustpilot Business</a></li>
						<li><a href="javascript:void(0)">Products</a></li>
						<li><a href="javascript:void(0)">Plans & Pricing</a></li>
						<li><a href="javascript:void(0)">Business Login</a></li>
						<li><a href="javascript:void(0)">Blog for Business</a></li>
					</ul>
				</div>
				<div class="col-md-2">
				<h5>Follow us on</h5>
  ...
  <dd>
    <ul style="display: none;">
      ...
      <li><a cunt_code="+263" href="javascript:void(0);"><span style="background-position:0px -2046px"></span><span>Zimbabwe</span><span>+263</span></a></li>
			...
			<p class="bottomm">© 2023 BestBookWriters, Inc. All rights reserved.</p>
	</div>
