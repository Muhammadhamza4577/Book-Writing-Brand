...
<div class="bcrumb-main">
	<div class="bcrumb-left two">
	<div class="container">
		<nav aria-label="breadcrumb">
  		<ol class="breadcrumb">
		<li class="breadcrumb-item"><a href="index">Home</a><i class="fa fa-chevron-right" aria-hidden="true"></i>
		</li>
...
<section class="blog-nav">
	<div class="container">
		<ul class="blogul">
			<li><a href="blog.php">Book Writing</a></li>
			<li><a href="blog-book-publishing.php">Book Publishing</a></li>
			<li class="active"><a href="blog-book-marketing.php">Book Marketing</a></li>
