...
<?php 
   $title = "Our Entire Book Writing Team | Best Book Writers";
   $descripion = "Our team is dedicated to provide overall book writing solutions with professionalism, and customer satisfaction. Visit our website to know more about our team.";
   $canonical = "https://bestbookwriters.com/about-us";
   ?> 
...
<main>
         ...
         <div class="row justify-content-center">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
               <div class="banner-content-about">
                  <h1>We Are Not Just Simply Writing Your Content, But We Are Helping <span style="color:#3EBEC1;font-family: poppins !important; text-transform: none;font-size: 40px !important;}"> You To Relive Your Dream
                  </span></h1>
   ...
   <section class="book-qoute-abt">
         <?php include('include/book-qoute-abt.php');?>
      </section>
   ...
   <section class="our-sat-client">
      <div class="container myclinent">
         <div class="row">
            <div class="col-md-12">
               <div class="ourclients-head">
                  <h1>Our Satisfied <span style="color:#3EBEC1;font-family: poppins !important; text-transform: none;font-size: 40px !important;}">Clients</span></h1>
