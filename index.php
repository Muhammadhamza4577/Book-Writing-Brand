...
<main>
                        ...
                        <div class="sub-head-about">
                                ...
                                <div class="banner-content2">
                                    <div class="desc-about-head">
                                        ...
                                        Do you want to know what makes us different from the conventional book writing industry and how our services differ from other providers? The following skills and attributes depict how our professional book writing services are different from other book writing company.</p>
                                        </div>
                                </div>
    ...
    <section class="amazon-testimonails">
        <?php include('include/amazon-testimonails.php');?>
    </section>
                        ...
                        <div class="porcess-img">
                            <div class="col-sm-6 process-boxes">
                                <div class="process-box">
                                    ...
                                    <div class="process-name"><h1>Book Writing</h1>
                                        <span class="process-divider">
                                            <div class="dividers-process"></div>
                                        </span>
                                    </div>
                                    <div class="process-desc"><p>Once we are done with the outline and the scope of your project..</p></div>
                                ...
                                <div class="process-box">
                                    ...
                                    <div class="process-name"><h1>Editing And Proofreading</h1>
                                        <span class="process-divider">
                                            <div class="dividers-process"></div>
                                        </span>
                                    </div>
                                    <div class="process-desc"><p>The assurance of quality remains the key process of book writing, and editing..</p></div>
                            ...
                            <div class="col-sm-6 process-boxes">
                                <div class="process-box">
                                    ...
                                    <div class="process-name"><h1>Book Formatting</h1>
                                        <span class="process-divider">
                                            <div class="dividers-process"></div>
                                        </span>
                                    </div>
                                    <div class="process-desc"><p>It is imperative to focus on proper formatting guidelines, and it is an essential..</p></div>
                                ...
                                <div class="process-box">
                                    ...
                                    <div class="process-name"><h1>Book Publishing</h1>
                                        <span class="process-divider">
                                            <div class="dividers-process"></div>
                                        </span>
                                    </div>
                                    <div class="process-desc"><p>We will move into this stage when your book is ready! Once your book is ready..</p></div>
