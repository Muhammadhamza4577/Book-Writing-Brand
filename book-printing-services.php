<?php 
    $title = "Book Printing Services Online | Best Book Writers";
    $descripion = "Print your own book with online book printing services from Best Book Writers. Quality service, great value for self-published authors.";
    $canonical = "https://bestbookwriters.com/book-printing-services";
                            ...
                            <div class="service-inner-box myboxheight">
                                <div class="service-box">
                                    ...
                                    <div class="service-ico">
                                        <img src="images/bookprinting/bookprinting-icon-01.png" alt="">
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="service-inner-box myboxheight">
                                <div class="service-box">
                                    ...
                                    <div class="service-ico">
                                        <img src="images/bookprinting/bookprinting-icon-02.png" alt="">
                                    </div>
                                    <div class="empty-box"></div>
                                </div>
                                <div class="service-head1">
                        ...
                        <div class="col-sm-3">
                            <div class="service-inner-box myboxheight">
                                <div class="service-box">
                                    ...
                                    <div class="service-ico">
                                        <img src="images/bookprinting/bookprinting-icon-03.png" alt="">
                                    </div>
                                    <div class="empty-box"></div>
                                </div>
                                <div class="service-head1">
                        ...
                        <div class="col-sm-3" >
                            <div class="service-inner-box myboxheight">
                                <div class="service-box">
                                    ...
                                    <div class="service-ico">
                                        <img src="images/bookprinting/bookprinting-icon-04.png" alt="">
                                    </div>
                                    <div class="empty-box"></div>
                                </div>
                                <div class="service-head1">
                        ...
                        <div class="col-sm-3">
                            <div class="service-inner-box myboxheight">
                                <div class="service-box">
                                    ...
                                    <div class="service-ico">
                                        <img src="images/bookprinting/bookprinting-icon-05.png" alt="">
                                    </div>
                                    <div class="empty-box"></div>
                                </div>
                                <div class="service-head1">
