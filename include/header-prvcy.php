...
<a class="navbar-brand" href="https://bestbookpublisher.com/"><img style="width:75%;" src="images/footer-logo.png" class="img-fluid" alt=""></a>
...
<ul class="navbar-nav">
<li class="nav-item">
<a aria-current="page" style="color:#000;" href="https://bestbookpublisher.com/">Home</a>
</li>
<li class="nav-item">
<a style="color:#000;" href="about-us">About Us</a>
</li>
<li class="nav-item dropdown_list">
<a style="color:#000;" href="services" class="on-desktop">Services <i class="fa fa-angle-down"></i></a>
...
<li class="nav-item">
<a style="color:#000;" href="blog.php">Blog</a>
</li>
<li class="nav-item">
...
<div class="phone">
	<div style="border: 1px solid #000;" class="icon_phone">
	<i style="color:#000;" class="fa fa-phone" aria-hidden="true"></i>
	</div>
	<div class="head_phone">
		<h5 style="color:#000;">.Live Chat</h5>
		<h4 style="color:#000;">+1-737-881-7227</h4>
	</div>
</div>
</a>

<!-- <button type="button" class="hvr-grow tc-image-effect-shine" data-bs-toggle="modal" data-bs-target="#exampleModal">Send Me a Quote</button> -->
</form>
</div>
</div>
</nav>
